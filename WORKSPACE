...
new_local_repository(
    ...
    path = "/mnt/d/programming/openCV_installation/opencv/build",
)
...
new_local_repository(
    name = "android_opencv",
    build_file = "@//third_party:opencv_android.BUILD",
    path = "/mnt/d/programming/OpenCV-android-sdk"
)
...
android_ndk_repository(
    name = "androidndk",
    path = "/mnt/d/android-ndk-r21e-linux-x86_64/android-ndk-r21e",
    api_level = 21
)
...
# android_ndk_repository(
#     name = "androidndk",
#     path = "D:\\programming\\android-ndk-r21e",
#     api_level = 21
# )
#
# android_sdk_repository(
...
#    url = #"https://github.com/bazelbuild/rules_apple/releases/download/0.19.0/rules_#apple.0.19.0.tar.gz",
    patches = [

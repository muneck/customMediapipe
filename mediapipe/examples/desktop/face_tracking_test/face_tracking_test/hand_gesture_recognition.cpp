...
Gesture GoogleMediapipeHandTrackingDetect::HandGestureRecognition::GestureRecognition(const std::vector<PoseInfo>& face_land_marks)
{
	...
	std::cout << "turn:" << face_land_marks[33].z << "-" << face_land_marks[263].z<<std::endl;
	std::cout << "tile" << face_land_marks[33].y << "-" << face_land_marks[263].y << std::endl;
	std::cout << "nod" << face_land_marks[1].z << "-" << face_land_marks[168].z << std::endl;
